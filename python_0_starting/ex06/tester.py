...
def is_exoplanet(name):
    """
    return true if name belongs to `exoplanets` list

    Args:
        x(str): value to verify

    Returns:
        bool: true if found in `exploplanets` list
    """
    exoplanets = \
